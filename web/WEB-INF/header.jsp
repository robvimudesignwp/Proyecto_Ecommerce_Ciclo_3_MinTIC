<%-- 
    Document   : header
    Created on : 6/09/2022, 3:53:00 p. m.
    Author     : rober
--%>
...
<header id="header"><!--header-->
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						<div class="logocompany pull-left"> 
						...
						<div class="btn-group pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default dropdown-toggle usa" data-toggle="dropdown">
									${sessionScope.name_moneda} (${sessionScope.moneda})
								...
								<ul class="dropdown-menu">
									...
									<li><a href="CambiarMoneda?moneda=USD">Dolar EE.UU (USD)</a></li>
									<li><a href="CambiarMoneda?moneda=CAD">Dolar Canadiense (CAD)</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-9">
						<div class="navbar-header">
							<button type="button" class="menu-mobile navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
