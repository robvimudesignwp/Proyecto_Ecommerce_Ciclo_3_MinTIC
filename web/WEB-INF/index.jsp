<%-- 
    Document   : index
    Created on : 26-Agosto-2022, 10:24:59
    Author     : rober
--%>
...
<head>
    ...
    <title>Tienda virtual pagos Online Paypal y Payu</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +57 3116232430</a></li>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="images/home/logo_ecommerce.svg" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="#"><i class="fa fa-credit-card"></i> Finalizar compra</a></li>
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<h3>Compra fácil y paga desde la comodidad de tu hogar</h3>
									<p>Somos tienda fisica y virtual con carrito de compras y pagos en línea con Paypal y Payu </p>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>E</span>-commerce</h1>
									<h2>15% de descuento en ropa para niños</h2>
									<p>Tenemos grandes descuentos especiales en ropa para niños y niñas aprovecha ya!... </p>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>E</span>-commerce</h1>
									<h2>Paga Online de forma segura y sin moverte de casa</h2>
									<p>Aprovecha nuestras ofertas, tenemos los mejores precios para ti</p>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Tienda diseñada por <span><a target="_blank" href="https://www.instagram.com/robvimudesign">Robvimu Design</a></span></p>
				</div>
			</div>
		</div>
